...
Pour lancer le serveur on doit se situer dans le dossier tp5/ et éxécuter la commande npm run build

### Travail réalisé

J'ai réalisé toutes les fonctionnalités demandés pour l'application.
